...
# https://github.com/rust-lang/rust/blob/bd0826a4521a845f36cce1b00e1dd2918ba09e90/src/ci/docker/host-x86_64/dist-x86_64-netbsd/build-netbsd-toolchain.sh
...
hide_output ./build.sh -j`nproc` -m amd64 tools
